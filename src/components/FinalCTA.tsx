  ...
  return (
    <section className="py-24 bg-background relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="relative bg-surface border-2 border-accent/40 rounded-3xl p-8 sm:p-14 lg:p-20 text-center shadow-[0_0_80px_rgba(0,240,144,0.15)] overflow-hidden">
          {/* Ambient Glowing Background Effect */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-accent-glow/30 blur-[140px] rounded-full pointer-events-none" />
          ...
          <div className="max-w-3xl mx-auto space-y-6 relative z-10">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-accent/10 border border-accent/30 text-accent text-xs font-semibold">
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
              <button
                onClick={onOpenAudit}
                className="w-full sm:w-auto px-10 py-5 bg-accent hover:bg-accent-hover text-background font-bold text-lg rounded-2xl shadow-xl shadow-accent/25 transition-all flex items-center justify-center gap-3 group"
              >
