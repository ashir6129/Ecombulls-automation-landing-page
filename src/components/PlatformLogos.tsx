...
export const AmazonLogo: React.FC<LogoProps> = ({ className = "h-7 w-auto", size }) => (
  <svg
    viewBox="0 0 110 35"
    className={className}
...
export const WalmartLogo: React.FC<LogoProps> = ({ className = "h-7 w-auto", size }) => (
  <svg
    viewBox="0 0 130 35"
    className={className}
    style={size ? { height: size, width: "auto" } : undefined}
...
export const TikTokShopLogo: React.FC<LogoProps> = ({ className = "h-7 w-auto", size }) => (
  ...
  >
    <path
      d="M19.6 6.7a4.8 4.8 0 0 1-3.8-4.2V2h-3.4v13.7a2.9 2.9 0 1 1-2.9-2.9c.1 0 .3 0 .4.1V9.3a6.3 6.3 0 1 0 5.9 6.3V9.5a8.2 8.2 0 0 0 4.8 1.5V7.5a4.8 4.8 0 0 1-1-.8z"
      fill="#FE2C55"
    />
    <text x="28" y="24" fontFamily="sans-serif" fontSize="18" fontWeight="800" fill="currentColor">
      TikTok Shop
    </text>
  </svg>
);

export const ShopifyLogo: React.FC<LogoProps> = ({ className = "h-7 w-auto", size }) => (
  <svg
    viewBox="0 0 125 35"
    className={className}
    style={size ? { height: size, width: "auto" } : undefined}
  ...
  >
    <path
      d="M22.3 5.5s-.3 0-.5.2l-2.1 2.1c-.2.2-.2.5 0 .7l.5.5c.2.2.5.2.7 0l2.1-2.1c.2-.2.2-.5 0-.7l-.7-.7zM18.8 9.5l-9.2 2.7s-.6.2-.7.6L5 25.5s-.2.6.2.9c.3.2.7.2.9 0l6.2-4.2 6.2 4.2c.2.2.6.2.9 0 .4-.3.2-.9.2-.9l-3.9-12.7c-.1-.4-.7-.6-.7-.6l-9.2-2.7zm2.4 12.2l-4.7-3.2 1.3-4.3 3.4 7.5z"
      fill="#95BF47"
    />
    <text x="30" y="24" fontFamily="sans-serif" fontSize="20" fontWeight="800" fill="currentColor">
      Shopify
    </text>
  </svg>
);
